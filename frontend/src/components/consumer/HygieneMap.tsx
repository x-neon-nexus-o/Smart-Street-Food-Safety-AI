...
const ICONS = {
  good: createIcon("#22c55e"), // green-500
  fair: createIcon("#eab308"), // yellow-500
  poor: createIcon("#f97316"), // orange-500
  bad: createIcon("#ef4444"), // red-500
  none: createIcon("#94a3b8"), // slate-400
};
